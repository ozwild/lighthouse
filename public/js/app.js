...
/*!*************************************!*\
  !*** ./resources/js/Helpers/DOM.js ***!
  \*************************************/
/*! exports provided: createDOMElement, createDOMButton, retrieveElementId */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createDOMElement", function() { return createDOMElement; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createDOMButton", function() { return createDOMButton; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "retrieveElementId", function() { return retrieveElementId; });
...
function createDOMButton() {
  var _ref2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      classNames = _ref2$classNames === void 0 ? ['btn'] : _ref2$classNames,
      _ref2$icon = _ref2.icon,
      icon = _ref2$icon === void 0 ? "" : _ref2$icon,
      _ref2$handler = _ref2.handler,
      handler = _ref2$handler === void 0 ? null : _ref2$handler,
  ...
  if (icon) $element.append(createDOMElement({
...
var retrieveElementId = function retrieveElementId(element) {
...
/* harmony import */ var _Lyrics_Constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Lyrics/Constants */ "./resources/js/Lyrics/Constants.js");
...
function decode(text) {
  var content, startTimestamp, endTimestamp;
  var startTimestampMatches, endTimestampMatches;
  startTimestampMatches = text.match(_Lyrics_Constants__WEBPACK_IMPORTED_MODULE_0__["timestampRX"]);

  if (startTimestampMatches) {
    startTimestamp = +startTimestampMatches[1];
  }

  text = text.replace(_Lyrics_Constants__WEBPACK_IMPORTED_MODULE_0__["timestampRX"], "");
  endTimestampMatches = text.match(_Lyrics_Constants__WEBPACK_IMPORTED_MODULE_0__["timestampRX"]);

  if (endTimestampMatches) {
    endTimestamp = endTimestampMatches[1];
  }

  content = text.replace(_Lyrics_Constants__WEBPACK_IMPORTED_MODULE_0__["timestampRX"], "").trim();
  return {
    content: content,
...
/***/ "./resources/js/Helpers/Eventful.js":
/*!******************************************!*\
  !*** ./resources/js/Helpers/Eventful.js ***!
  \******************************************/
/*! exports provided: default */
...
function () {
  ...
  _createClass(Eventful, [{
    key: "_assignHandler",
    value: function _assignHandler(eventName, handler) {
      var list = this.eventHandlers[eventName];
    ...
    value: function on(event, handler) {
      ...
      if (event instanceof Array) {
        event.map(function (eventName) {
          return _this2._assignHandler(eventName, handler);
        });
      } else {
    ...
    value: function trigger(event) {
      ...
      if (event instanceof Array) {
        event.map(function (eventName) {
          return _this3._dispatch.apply(_this3, [eventName].concat(args));
        });
      } else {
        this._dispatch.apply(this, [event].concat(args));
      }
    }
  }]);
...
/***/ "./resources/js/Lyrics/Constants.js":
/*!******************************************!*\
  !*** ./resources/js/Lyrics/Constants.js ***!
  \******************************************/
/*! exports provided: timestampRX, groupRX, groupSeparatorReplacement, TIMESTAMPS_IDENTIFIERS */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "timestampRX", function() { return timestampRX; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "groupRX", function() { return groupRX; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "groupSeparatorReplacement", function() { return groupSeparatorReplacement; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TIMESTAMPS_IDENTIFIERS", function() { return TIMESTAMPS_IDENTIFIERS; });
var timestampRX = /(?:\[)([\d.]+)(?:])/;
var groupRX = /[\r\n]\s{2,}/g;
var groupSeparatorReplacement = '[break here]';
var TIMESTAMPS_IDENTIFIERS = {
  "START": Symbol('START'),
  "END": Symbol('END')
};
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Constants */ "./resources/js/Lyrics/Constants.js");
/* harmony import */ var _Helpers_DOM__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Helpers/DOM */ "./resources/js/Helpers/DOM.js");
...
function () {
  function Lyric(text) {
    ...
    _defineProperty(this, "activeTimestampIdentifier", void 0);

    var decoded = Object(_Helpers_Data__WEBPACK_IMPORTED_MODULE_3__["decode"])(text);
  ...
  _createClass(Lyric, [{
    ...
    value: function select() {
      ...
      this.activeTimestampIdentifier = _Constants__WEBPACK_IMPORTED_MODULE_1__["TIMESTAMPS_IDENTIFIERS"].START;
    }
  }, {
    key: "deselect",
    ...
    value: function updateTimestamp(timestamp) {
      switch (this.activeTimestampIdentifier) {
        case _Constants__WEBPACK_IMPORTED_MODULE_1__["TIMESTAMPS_IDENTIFIERS"].START:
          ...
          this.activeTimestampIdentifier = _Constants__WEBPACK_IMPORTED_MODULE_1__["TIMESTAMPS_IDENTIFIERS"].END;
          return;

        case _Constants__WEBPACK_IMPORTED_MODULE_1__["TIMESTAMPS_IDENTIFIERS"].END:
          this.end = timestamp;
          this.activeTimestampIdentifier = null;
          return;
      }
    ...
    value: function repaintSelectionState() {
      ...
      } else this.$element.removeClass(stateClass);

      this.repaintTimestampState();
    }
  }, {
    key: "repaintTimestampState",
    value: function repaintTimestampState() {
      this.$element.find('.lyric-start, .lyric-end').removeClass("active");
      if (this.activeTimestampIdentifier === _Constants__WEBPACK_IMPORTED_MODULE_1__["TIMESTAMPS_IDENTIFIERS"].END) this.$element.find('.lyric-end').addClass("active");else if (this.activeTimestampIdentifier === _Constants__WEBPACK_IMPORTED_MODULE_1__["TIMESTAMPS_IDENTIFIERS"].START) this.$element.find('.lyric-start').addClass("active");
    }
  }, {
    key: "repaintActiveState",
    value: function repaintActiveState() {
      var stateClass = "active";
      if (this.isActive) this.$element.addClass(stateClass);else this.$element.removeClass(stateClass);
    }
  }, {
    key: "toString",
    value: function toString() {
      return Object(_Helpers_Data__WEBPACK_IMPORTED_MODULE_3__["encode"])(this);
    }
  }, {
...
/***/ "./resources/js/Lyrics/LyricsDisplayController.js":
/*!********************************************************!*\
  !*** ./resources/js/Lyrics/LyricsDisplayController.js ***!
  \********************************************************/
/*! exports provided: default */
...
/***/ "./resources/js/Lyrics/LyricsSyncController.js":
/*!*****************************************************!*\
  !*** ./resources/js/Lyrics/LyricsSyncController.js ***!
  \*****************************************************/
/*! exports provided: default */
  ...
  _createClass(LyricsSyncService, [{
    ...
    value: function process() {
      this.lyrics = this.record.lyrics.split("\n").map(function (lyricText) {
        return new _SyncLyric__WEBPACK_IMPORTED_MODULE_1__["default"](lyricText);
      });
    }
  }, {
    key: "selectTimestamp",
    value: function selectTimestamp(identifier) {
      if (!this.selectedLyric) {
        return;
      }
...
/***/ "./resources/js/Lyrics/SyncLyric.js":
/*!******************************************!*\
  !*** ./resources/js/Lyrics/SyncLyric.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SyncLyric; });
/* harmony import */ var _Lyric__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Lyric */ "./resources/js/Lyrics/Lyric.js");
/* harmony import */ var _Helpers_DOM__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Helpers/DOM */ "./resources/js/Helpers/DOM.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return YTAPILoader; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
/*#__PURE__*/
function () {
  function YTAPILoader() {
    _classCallCheck(this, YTAPILoader);
  }

  _createClass(YTAPILoader, null, [{
    ...
    value: function load() {
      ...
      return new Promise(function (resolve) {
        document.addEventListener('youtube.ready', function (e) {
          resolve();
        });
      });
    }
...
__webpack_require__(/*! /mnt/e/www/lighthouse.local/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /mnt/e/www/lighthouse.local/resources/sass/app.scss */"./resources/sass/app.scss");
